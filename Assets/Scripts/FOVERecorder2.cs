...
public class FOVERecorder2 : MonoBehaviour
{
    ...
    class RecordingDatum
    {
        ...
        //public float eyeAccuracy;
        //public float eyeDistance;
       
        public Vector3 eyePosition; //Yet another new functionality
    }
    ...
    void OnApplicationQuit()
    {
        ...
        writeThread.Join(1000); // 1000 milliseconds
    }
    ...
    IEnumerator RecordData()
    {
        ...
        while (true)
        {
            ...
            if (recordingStopped) //changed to false - Riz
                continue;
            ...
            RecordingDatum datum = new RecordingDatum
            {
                ...
                //eyeDistance = gaze.distance,
                //eyeAccuracy = gaze.accuracy,

                eyePosition = gaze.ray.GetPoint(gaze.distance)*100
            };
        ...
        if (dataToWrite != null)
        {
            ...
            try
            {
                ...
                foreach (var datum in dataToWrite)
                {
                    ...
                    //    datum.eyeDirection.origin.x.ToString(vPrecision), //new stuff
                    //    datum.eyeDirection.origin.y.ToString(vPrecision),
                    //    datum.eyeDirection.origin.z.ToString(vPrecision),
                    //    datum.eyeDistance.ToString(vPrecision),
                    //    datum.eyeAccuracy.ToString(vPrecision),
